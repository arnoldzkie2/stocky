  ...
  return (
    <div>
      ...
      <div className='flex items-center h-screen w-screen bg-[url(/auth.webp)] bg-no-repeat bg-cover bg-center justify-between pt-24 px-5 sm:px-10 md:px-16 lg:px-24 xl:px-36 2xl:px-44'>
        <div className='w-full flex items-center h-full justify-between px-5 2xl:px-10 border-x border-slate-800'>
          ...
          <form onSubmit={registerUser} className='bg-slate-800 w-[29rem] p-7 py-10 rounded-md shadow shadow-white flex flex-col items-center gap-4'>
            <input onChange={handleChange} name='name' className='w-full bg-slate-700 border-b text-sm md:text-base px-3 text-slate-200 outline-none py-1.5' type="text" placeholder='Name' />
            <input onChange={handleChange} name='email' className='w-full bg-slate-700 border-b text-sm md:text-base px-3 text-slate-200 outline-none py-1.5' type="email" placeholder='Email' />
            <div className='flex items-center gap-4 relative w-full'>
              ...
              <input onChange={handleChange} name='confirm_password' className='w-full bg-slate-700 border-b text-sm md:text-base px-3 text-slate-200 outline-none py-1.5' type={eye ? 'password' : 'text'} placeholder='Confirm Password' />
            </div>
