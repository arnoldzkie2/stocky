...
const DepositModal: React.FC<Props> = ({ formData, setFormData, user, setIsDeposit }) => {
    ...
    const depositCoin = async (e: any) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${process.env.NEXT_PUBLIC_API_BACKEND}/api/v1/deposit`, {
                coin, amount
            }, {
                headers: {
