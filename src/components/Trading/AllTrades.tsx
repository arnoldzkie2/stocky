        ...
        <div className='flex text-xs flex-col items-center w-full pt-7 gap-6 text-[10px]'>
            ...
            <div className='flex flex-col w-full'>
                ...
                <div className='w-full h-72 overflow-y-auto'>
                    {allTrades && allTrades.length > 0 ? <table className="w-full text-left text-gray-500 dark:text-gray-400">
                            ...
                            {allTrades.length > 0 && allTrades.map((item) => {
                                ...
                                return (
                                    <tr className="bg-white border-b text-slate-200 dark:bg-gray-800 dark:border-gray-700" key={item.id}>
                                        <th scope="row" className={`p-3 font-medium flex items-center gap-1 whitespace-nowrap ${item.type === 'buy' ? 'text-green-400' : 'text-red-500'}`}>
            ...
            <div className='flex flex-col w-full'>
                ...
                <div className='w-full h-72 overflow-y-auto'>
                    ...
                    {myTrades && myTrades.length > 0 ? <table className="w-full text-left text-gray-500 dark:text-gray-400">
                        <thead className="text-xs text-slate-200 bg-gray-50 dark:bg-slate-700 dark:text-white">
                            <tr>
                                <th scope="col" className="p-3">
                                    Price
