...
const TradeButtons: React.FC<Props> = ({ price, buyType, setBuyType, setPrice, buyWith, buyForm, setBuyForm, coin, sellForm, setSellForm }) => {
            ...
            {buyType === 'limit' ?
                <div className='flex items-center w-full justify-between gap-5 md:gap-10 text-slate-300 text-sm'>
                    ...
                    <div className='flex w-full flex-col gap-2'>
                        ...
                        <button className='w-full mt-2.5 hover:bg-green-400 rounded-md h-10 bg-green-500 uppercase font-bold text-white'>BUY {coin}</button>
                    </div>
                    ...
                    <div className='flex w-full flex-col gap-2'>
                        ...
                        <div className='flex items-center w-full'>
                            <div className='w-full relative'>
                                ...
                                }} className='outline-none px-20 text-right py-1 w-full bg-slate-900 border border-slate-800' value={sellForm.total ? sellForm.total : ''} />
                                <div className='absolute right-3 top-[5px] uppercase'>{buyWith}</div>
                            </div>
                        </div>
                        <button className='w-full mt-2.5 hover:bg-red-400 rounded-md h-10 text-white font-bold bg-red-500 uppercase'>SELL {coin}</button>
                    </div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (parts.length > 2) {
                                            ...
                                            setSellForm(prevState => ({ ...prevState, amount: sanitizedInput }));
                                        } else {
                                            setSellForm(prevState => ({ ...prevState, amount: numericInput }));
                                        }
                                    }}
                                />
                                <div className='absolute right-3 top-[5px] uppercase'>{coin}</div>
