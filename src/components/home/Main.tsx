...
const Main = () => {
    ...
    return (
        <main className=' bg-[url(/bg.svg)] w-screen bg-no-repeat bg-cover pt-20 lg:pt-16 lg:h-screen pb-10 flex flex-col items-center justify-center px-5 sm:px-10 md:px-16b lg:px-24 xl:px-36 2xl:px-44'>
